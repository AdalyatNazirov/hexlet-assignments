...
class ValidationTest {
    ...
    void testAdvanceValidate() {
        ...
        Map<String, List<String>> expected2 = Map.of("country", List.of("Field cannot be null"));
        assertThat(result2).isEqualTo(expected2);

        Address address3 = new Address("USA", null, null, null, "1");
        Map<String, List<String>> result3 = Validator.advancedValidate(address3);
        Map<String, List<String>> expected3 =
                Map.of("country", List.of("Field should be at list 4 in length"),
                        "city", List.of("Field cannot be null"),
                        "street", List.of("Field cannot be null"),
                        "houseNumber", List.of("Field cannot be null"));
        assertThat(result3).isEqualTo(expected3);
    }
    // END
}
